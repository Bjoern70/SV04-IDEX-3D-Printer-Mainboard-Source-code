...
#define Z_STEPPER_AUTO_ALIGN
  ...
  //#define Z_STEPPER_ALIGN_XY { { 32.9, 22.5 }, { 272.9, 22.5 }}
  #define Z_STEPPER_ALIGN_XY { { 32.9, 262.5 }, { 272.9, 262.5 }}
...
#define ASSISTED_TRAMMING
  ...
  //#define TRAMMING_POINT_XY { { 32.9, 22.5 }, { 272.9, 22.5 }, { 272.9, 262.5 }, { 32.9, 262.5 } } //Limited by front margin
  #define TRAMMING_POINT_XY { { 32.9, 25 }, { 272.9, 25 }, { 272.9, 262.5 }, { 32.9, 262.5 } }
...
// LCD Print Progress options
  ...
  #define EVENT_GCODE_SD_ABORT "G28 X"      // Home toolheads
...
#define MAX_CMD_SIZE 161 //Allow longer filenames
#define BUFSIZE 4
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_TEMPERATURE_0      200  // Target temperature in °C for changing filament in extruder 0
  #define FILAMENT_CHANGE_TEMPERATURE_1      200  // Target temperature in °C for changing filament in extruder 1
  #define FILAMENT_LOAD_LENGTH_0              10  // (mm) Length to extrude after loading in extruder 0
  #define FILAMENT_LOAD_LENGTH_1              10  // (mm) Length to extrude after loading in extruder 1
#endif
