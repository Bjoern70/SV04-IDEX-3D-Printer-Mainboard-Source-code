...
/*    #if ENABLED(RTS_AVAILABLE)
      ...
      {
        //Debug enabled
        SERIAL_ECHOLNPGM("RTS =>  G0_G1. Return to display screen #", rtscheck.RTS_currentScreen);
        sprintf(rtscheck.RTS_infoBuf, "G0_G1: Last[%d] Goto Cur[%d] waitW=%d DXC=%d", rtscheck.RTS_lastScreen, rtscheck.RTS_currentScreen, RTS_waitway, dualXPrintingModeStatus);
